...
s=Stack()
print(s)
s.push(list_([list_([num_(1),num_(2),num_(3)]),list_([num_(4),num_(5),num_(6)]),list_([num_(7),num_(8),num_(9)])]))
s.push(num_(10000000000000000+9999999999999999999999j))
s.push("'\x00\x01\xff∞'")
print(s,"push")
s.push(list_([num_(0),num_(1),num_(-1)]))
s.moveUp()
print(s,"moveUp")
s.push(list_([num_(0),num_(1),num_(-1)]))
s.moveDown()
...
print("Test str to value",value("[None,4^2~3,True,'\\1\\55',\"test value()\",[False,0] ,[type],{4}]"))# ,[0:\"0\",1:\"1\"],{₴}(→ @2 @2 + P p)
