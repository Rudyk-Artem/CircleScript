...
def functionTest():
    ...
    s.type()
    print(s,"type")
    s.push("⟨None;(2↧4~i*2√3+2^1/∞);True;'\\1\\55\\0123456789ABCDEF';\"test value()\";[False,0,\'abc\'];[0:\"0\",1:\"1\"];(→ @2 @2 + @[str] F p);[type];{4}⟩")
...
def function_Test():
    print("\n\tTest function_:")
    s=Stack()
    f=function_('{@True}(@[str] F p ⇁ @3 @3 *  |⇀ @"anc: " @3 @3 + @[str] F & p)',s)
    f.do()
    print(s)
    s.push(['{@{}(@"foo" p) @True}(@[str] F p ⇁ @3 @3 *  |⇀ @"anc: " @3 @3 + @[str] F & p)',"(12+3)"])
    print(s)
# arithmeticTest()
# functionTest()
# typeTest()
